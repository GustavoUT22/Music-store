...
ActiveRecord::Schema[7.0].define(version: 2023_04_14_204054) do
  ...
  create_table "song_albums", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["album_id"], name: "index_song_albums_on_album_id"
    t.index ["song_id"], name: "index_song_albums_on_song_id"
  end
